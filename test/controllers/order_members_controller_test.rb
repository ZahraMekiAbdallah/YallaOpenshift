...
class OrderMembersControllerTest < ActionController::TestCase
  ...
  test "should create order_member" do
    assert_difference('OrderMember.count') do
      post :create, order_member: { joined: @order_member.joined, order_id: @order_member.order_id, user_id: @order_member.user_id }
    end
  ...
  test "should update order_member" do
    patch :update, id: @order_member, order_member: { joined: @order_member.joined, order_id: @order_member.order_id, user_id: @order_member.user_id }
    assert_redirected_to order_member_path(assigns(:order_member))
  end
